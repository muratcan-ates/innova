...
- [ ] T005 Configure Tailwind v4 theme tokens in `app/globals.css`: surface `#0A0A0A`, card `#141414`, accent `#6366F1`, border-radius cap 12px, WCAG AA contrast — per Constitution Principle VII.
